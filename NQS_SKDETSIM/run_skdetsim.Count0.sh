...
#<<COMMENTOUT
### MC input file from NEUT
NEUTVECT=/disk02/usr6/sedi/NEUTvect/fhc.num.VECTcount000.part003.dat
### output file of SKDETSIM
DSOUT=/disk02/usr6/sedi/SKDETSIM/output/fhc.numu.skdetsim.0026Gd.NEUTcount000.part003.zbs

### Execution of SKDETSIM
$DSDIR/skdetsim $DSCARD\
			    $DSOUT\
			    $NEUTVECT &> /disk02/usr6/sedi/SKDETSIM/Log/fhc.numu.0026Gd.NEUTcount000.part003.txt
#COMMENTOUT

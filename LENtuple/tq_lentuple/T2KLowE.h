...
public:
    ...
    Float_t         dirks; //CPM Bonsai directional goodness
    Float_t         goodness2; //CPM fit goodness squared
    Float_t         dirks2; //CPM directional goodness squared

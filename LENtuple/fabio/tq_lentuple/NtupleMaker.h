...
extern "C" {
    ...
    void kzeclr_();
    void skgetv_();
    void readfqzbsbank_(int*); //Added by Seidai (2021.7.1) /usr/local/sklib_gcc4.8.5/atmpd_19b/src/recon/fitqun/readfqzbsbank.F
    void inpmt_(float*, int*); //Added by Seidai (2021.7.2) 
    //void lowbs3get_();
...
bool inPMT; //Added by Seidai (2021.7.14)
...
public:
    ...
    bool ReadDataEvent();
    void SaveToTree();
    void prompt_hit_veto(int hitnum, float hittime); //Added by Seidai (2021.7.12)

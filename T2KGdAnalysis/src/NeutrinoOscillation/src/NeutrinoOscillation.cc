...
void NeutrinoOscillation::SetHistoFrame() {
  ...
  for (int i=0; i<INTERACTIONTYPE; i++) {
    ...
    h1_TruthOscProbRatio[i] = new TH1F(TString::Format("h1_TruthOscProbRatio_mode%d", i), "Oscillation Probability; Truth Neutrino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    ...
    h1_NoOsc_wTruthNeutron[i]  = new TH1F(TString::Format("h1_NoOsc_wTruthNeutron_mode%d", i), "No Oscillation w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    h1_NoOsc_woTruthNeutron[i] = new TH1F(TString::Format("h1_NoOsc_woTruthNeutron_mode%d", i), "No Oscillation w/o Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    h1_NoOsc_wNeutron[i]       = new TH1F(TString::Format("h1_NoOsc_wNeutron_mode%d", i), "No Oscillation w/ Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    h1_NoOsc_woNeutron[i]      = new TH1F(TString::Format("h1_NoOsc_woNeutron_mode%d", i), "No Oscillation w/o Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    ...
    h1_OscProb_wTruthNeutron[i]  = new TH1F(TString::Format("h1_OscProb_wTruthNeutron_mode%d", i), "Oscillation Probability w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    h1_OscProb_woTruthNeutron[i] = new TH1F(TString::Format("h1_OscProb_woTruthNeutron_mode%d", i), "Oscillation Probability w/o Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6.);
    ...
    h1_OscProbRatio_wTruthNeutron[i]  = new TH1F(TString::Format("h1_OscProbRatio_wTruthNeutron_mode%d", i), "Oscillation Probability w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6.);
    h1_OscProbRatio_woTruthNeutron[i] = new TH1F(TString::Format("h1_OscProbRatio_woTruthNeutron_mode%d", i), "Oscillation Probability w/o Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6.);
    h1_OscProbRatio_wNeutron[i]       = new TH1F(TString::Format("h1_OscProbRatio_wNeutron_mode%d", i), "Oscillation Probability w/ Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6.);
    h1_OscProbRatio_woNeutron[i]      = new TH1F(TString::Format("h1_OscProbRatio_woNeutron_mode%d", i), "Oscillation Probability w/o Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6.);
    */
  }
  ...
  */
  ...
  //h1_All_NoOsc_wTruthNeutron  = new TH1F("h1_All_NoOsc_wTruthNeutron", "No Oscillation w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  ...
  //h1_All_NoOsc_wNeutron       = new TH1F("h1_All_NoOsc_wNeutron", "No Oscillation w/ Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  ...
  //h1_All_OscProb                = new TH1F("h1_All_OscProb", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}); Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  //h1_All_OscProb_wTruthNeutron  = new TH1F("h1_All_OscProb_wTruthNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  //h1_All_OscProb_woTruthNeutron = new TH1F("h1_All_OscProb_woTruthNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/o Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  //h1_All_OscProb_wNeutron       = new TH1F("h1_All_OscProb_wNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/ Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  //h1_All_OscProb_woNeutron      = new TH1F("h1_All_OscProb_woNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/o Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Number of Neutrino Events", 60, 0, 6);
  ...
  //h1_All_OscProbRatio_wTruthNeutron  = new TH1F("h1_All_OscProbRatio_wTruthNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/ Truth Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6);
  ...
  //h1_All_OscProbRatio_wNeutron       = new TH1F("h1_All_OscProbRatio_wNeutron", "Oscillation Probability(#nu_{#mu}#rightarrow#nu_{#mu}) w/ Tagged Neutrons; Reconstructed Neurtino Energy[GeV]; Ratio to No Oscillation", 60, 0, 6);
  ...
  */
  ...
  h1_EnuResoPrediction = new TH1F("h1_EnuResoPrediction", "Predicted Neutrino Energy Resolution; (E^{true}_{#nu}-E^{predict}_{#nu})/E^{true}_{#nu}; Number of Neutrino Events", 100, -1, 1);
...
/*bool NeutrinoOscillation::GetFrontMu(CC0PiNumu* numu) {

  bool thisisfront = false;
  //muon hypothesis
  float mudirx = numu->var<float>("fq1rdir", 0, 2, 0);
  float mudiry = numu->var<float>("fq1rdir", 0, 2, 1);
  float mudirz = numu->var<float>("fq1rdir", 0, 2, 2);

  if (mudirx > 0. && mudiry < 0. && mudirz > -0.5 && mudirz < 0.5) thisisfront = true;
...
void NeutrinoOscillation::WritePlots() {
  ...
  //h1_All_OscProbRatio_wNeutron -> Divide(h1_All_NoOsc_wNeutron);

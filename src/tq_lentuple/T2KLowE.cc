...
void T2KLowE::createTree (TTree *tree) {
    ...
    tree->Branch("dirks",        &dirks,        "dirks/F"); //CPM directional goodness
    tree->Branch("goodness2",           &goodness2,           "goodness2/F");  //CPM  Bonsai fit goodness squared
    tree->Branch("dirks2",        &dirks2,        "dirks2/F"); //CPM directional goodness squared
